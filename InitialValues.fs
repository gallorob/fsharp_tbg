module TextBasedGame.InitialValues
...
let allRooms = [
    {
        ...
        Exits = {
            ...
            South = PassableExit("You see a door to the south. A waft of cold hair hits your face.", RoomId "south1")
    ...
    }
    {
        ...
        Exits = {
            ...
            South = NoExit None
            East = NoExit None
            West = PassableExit("You see a stone doorway to the west. Why would you want to go back there?", RoomId "center")
        }
    }
]
